import MiJSLexer from "./generated/MiJSLexer.js";
import MiJSParser from "./generated/MiJSParser.js";
import { CustomMiJSListener } from "./CustomMiJSListener.js";
import { CustomMiJSVisitor } from "./CustomMiJSVisitor.js";
...
async function main() {
    ...
    let lexer = new MiJSLexer(inputStream);
    let tokenStream = new CommonTokenStream(lexer);
    let parser = new MiJSParser(tokenStream);
